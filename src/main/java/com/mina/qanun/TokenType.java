...
public enum TokenType {
	...
	SLASH, SLASH_EQUAL,
	PERCENTAGE, PERCENTAGE_EQUAL, QUESTION_MARK, COLON, ARROW,
	// Literals.
	IDENTIFIER, STRING, NUMBER,
	// Keywords.
	AND, CLASS, ELSE, FALSE, FUN, FOR, IF, NIL, OR, STATIC,
	RETURN, SUPER, THIS, TRUE, VAR, VAL, WHILE, BREAK, CONTINUE, SWITCH, CASE, DEFAULT, IMPORT,
	EOF
}
